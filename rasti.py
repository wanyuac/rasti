...
def parse_arguments():
    ...
    caller_parser.add_argument('--genome_list', '-g', dest = 'genome_list', type = str, required = True, help = "Input: a test file listing names of genomes. It can be \'genome_list.txt\' in the output directory of \'rasti detect\'.")
